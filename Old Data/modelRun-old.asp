...
<form METHOD="POST" ACTION="http://<%response.write(Application("name"))%>:8080/servlet/MinilakeSimulation">
  ...
  <div align="center"><center>
    <table border="0" cellpadding="0" width="677" cellspacing="0" bgcolor="#C0C0C0" style="border-collapse: collapse" bordercolor="#111111">
    <tr>
      <td width="349" bgcolor="#FFFFFF"><strong><big>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      Start Simulation:</big></strong></td>
      <td width="191" bgcolor="#FFFFFF"><input type="radio" value="simulate" checked name="R0"> <big>yes</big></td>
    </tr>
    <tr>
      <td width="349" bgcolor="#C0C0C0"><strong><big>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      Start Simulation<span lang="en-us"> (Future)</span>:</big></strong></td>
      <td width="191" bgcolor="#C0C0C0"><input type="radio" value="future" name="R0"> <big>yes</big></td>
    </tr>
    <tr>
      <td width="349" bgcolor="#FFFFFF"><strong><big>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      Add Field Data:</big></strong></td>
      <td width="191" bgcolor="#FFFFFF"><input type="radio" value="dataField" name="R0"> <big>yes</big></td>
    </tr>
    <tr>
      <td width="349" bgcolor="#C0C0C0"><strong><big>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      
      Lake Parameter Files</big></strong></td>
      <td width="191" bgcolor="#C0C0C0"><input type="radio" value="download" name="R0"> <big>download</big></td>
    </tr>
  </table>
