...
class WeatherScraperLegacy:
    ...
    def _get_airport_code(self, index):
        ...
        airport_url = "https://airport.globefeed.com/US_Nearest_Airport_Result.asp?lat=" + \
            self.lat + "&lng=" + self.lng
        ...
        airport_parsed = BeautifulSoup(
            airport_page.text, features="html.parser")
    ...
    def _get_weather_data(self):
        ...
        try:
            ...
            self.weather_page = BeautifulSoup(
                weather_html, features='html.parser')
    ...
    def _format_data(self):
        ...
        for column in self.dataset:
            ...
            # time column only has one header where as the other columns have max,avg, and min
            if column == self.dataset[0]:
                section = days
